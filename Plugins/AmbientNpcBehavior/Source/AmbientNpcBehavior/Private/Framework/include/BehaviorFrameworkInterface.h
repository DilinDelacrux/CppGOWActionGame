...
// This header is compiled directly into the plugin module (not linked against a
// separate shared library), so the API macro is intentionally left empty.
#ifndef AmbientCoreFramework_API
    #define AmbientCoreFramework_API
#endif
