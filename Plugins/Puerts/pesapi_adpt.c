...
typedef pesapi_value (*pesapi_create_functionType)(pesapi_env env, pesapi_callback native_impl, void* data);
static pesapi_create_functionType pesapi_create_function_ptr;
...
typedef bool (*pesapi_get_privateType)(pesapi_env env, pesapi_value object, void** out_ptr);
static pesapi_get_privateType pesapi_get_private_ptr;
bool pesapi_get_private (pesapi_env env, pesapi_value object, void** out_ptr) {
    return pesapi_get_private_ptr(env, object, out_ptr);
}

typedef bool (*pesapi_set_privateType)(pesapi_env env, pesapi_value object, void* ptr);
static pesapi_set_privateType pesapi_set_private_ptr;
bool pesapi_set_private (pesapi_env env, pesapi_value object, void* ptr) {
    return pesapi_set_private_ptr(env, object, ptr);
}
...
void pesapi_init(pesapi_func_ptr* func_array){
    ...
    pesapi_open_scope_placement_ptr = (pesapi_open_scope_placementType)func_array[58];
    ...
    pesapi_close_scope_placement_ptr = (pesapi_close_scope_placementType)func_array[62];
    pesapi_create_value_ref_ptr = (pesapi_create_value_refType)func_array[63];
    pesapi_duplicate_value_ref_ptr = (pesapi_duplicate_value_refType)func_array[64];
    pesapi_release_value_ref_ptr = (pesapi_release_value_refType)func_array[65];
    pesapi_get_value_from_ref_ptr = (pesapi_get_value_from_refType)func_array[66];
    pesapi_set_ref_weak_ptr = (pesapi_set_ref_weakType)func_array[67];
    pesapi_set_owner_ptr = (pesapi_set_ownerType)func_array[68];
    pesapi_get_ref_associated_env_ptr = (pesapi_get_ref_associated_envType)func_array[69];
    pesapi_get_ref_internal_fields_ptr = (pesapi_get_ref_internal_fieldsType)func_array[70];
    pesapi_get_property_ptr = (pesapi_get_propertyType)func_array[71];
    pesapi_set_property_ptr = (pesapi_set_propertyType)func_array[72];
    pesapi_get_private_ptr = (pesapi_get_privateType)func_array[73];
    pesapi_set_private_ptr = (pesapi_set_privateType)func_array[74];
    pesapi_get_property_uint32_ptr = (pesapi_get_property_uint32Type)func_array[75];
    pesapi_set_property_uint32_ptr = (pesapi_set_property_uint32Type)func_array[76];
    pesapi_call_function_ptr = (pesapi_call_functionType)func_array[77];
    pesapi_eval_ptr = (pesapi_evalType)func_array[78];
    pesapi_global_ptr = (pesapi_globalType)func_array[79];
    pesapi_get_env_private_ptr = (pesapi_get_env_privateType)func_array[80];
    pesapi_set_env_private_ptr = (pesapi_set_env_privateType)func_array[81];
    pesapi_alloc_type_infos_ptr = (pesapi_alloc_type_infosType)func_array[82];
    pesapi_set_type_info_ptr = (pesapi_set_type_infoType)func_array[83];
    pesapi_create_signature_info_ptr = (pesapi_create_signature_infoType)func_array[84];
    pesapi_alloc_property_descriptors_ptr = (pesapi_alloc_property_descriptorsType)func_array[85];
    pesapi_set_method_info_ptr = (pesapi_set_method_infoType)func_array[86];
    pesapi_set_property_info_ptr = (pesapi_set_property_infoType)func_array[87];
    pesapi_define_class_ptr = (pesapi_define_classType)func_array[88];
    pesapi_get_class_data_ptr = (pesapi_get_class_dataType)func_array[89];
    pesapi_trace_native_object_lifecycle_ptr = (pesapi_trace_native_object_lifecycleType)func_array[90];
